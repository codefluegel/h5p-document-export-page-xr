 ...
 */
H5P.DocumentExportPageXR = (function ($, EventDispatcher) {
  // CSS Classes:
  ...
  DocumentExportPage.prototype.initDocumentExportButton = function () {
    var self = this;
    H5P.DocumentationToolXR.handleButtonClick(self.$exportDocumentButton, function () {
      // Check if all required input fields are filled
      if (self.isRequiredInputsFilled()) {
        var exportDocument = new H5P.DocumentExportPageXR.CreateDocument(self.params, self.exportTitle, self.submitEnabled, self.inputArray, self.inputGoals);
...
export default H5P.DocumentExportPageXR;
